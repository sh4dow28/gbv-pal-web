    ...
    public function store(Request $request)
    {
        ...
        if ($request->typeProd == 'badge') {
            $rules = [
                ...
                'pereEmp'            => 'bail|required',
                'mereEmp'         => 'bail|required',
                'dobEmp'     => 'bail|array|min:1',
                'pobEmp'   => 'bail|required',
                'nationEmp'            => 'bail|required',
                'sexeEmp'         => 'bail|required',
                'adrEmp'     => 'bail|array|min:1',
                'telEmp'   => 'bail|required',
                'posteEmp'            => 'bail|required',
                'typeIDEmp'         => 'bail|required',
                'numIDEmp'     => 'bail|array|min:1',
                'expIDEmp'   => 'bail|required',
                'numFisc'            => 'bail|required',
            ];
            ...
            $rules = [
                ...
                'numFisc'            => 'bail|required',
                'noBadge'            => 'bail|required',
            ];
            $badge = ProductionBadge::where('noBadge', '=', $request->noBadge)->first();
        }
