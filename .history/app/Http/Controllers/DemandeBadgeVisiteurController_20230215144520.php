...
class DemandeBadgeVisiteurController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $messages = [
            ...
            'numVBadge.required'     => 'Le numéro de badge est requis',
            'numVBadge.exists'       => 'Le numero de badge entré n\'existe pas',
        ];
        $rules = [
            ...
            'numVBadge'      => 'bail|required|exists:tbl_badge_visiteur',
        ];
        ...
        if ($validator->stopOnFirstFailure()->fails()) {
            ...
            $badge = BadgeVisiteur::where('numVBadge', '=', $request->numVBadge)->first();
            ...
            return back()->with('message', 'Badge ajouter avec succès !');
        }
    }
