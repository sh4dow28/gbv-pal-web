...
class ProductionBadgeController extends Controller
{
    ...
    public function withdrawal(Request $request)
    {
        ...
        $vignette = DB::update('update tbl_demande_production,vignettes_production set badges_production.noBadge = :noBadge, tbl_demande_production.statProd = :stat where tbl_demande_production.idProd = badges_production.idProd and tbl_demande_production.idProd = :idProd', ['noBadge' => $request->noBadge, 'stat' => 'Terminé', 'idProd' => $request->idProd]);
