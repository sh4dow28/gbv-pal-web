...
Route::get('/badge/store', [ProductionBadgeController::class, 'store'])->name('badge.store');

Route::get('/vignette/create', [ProductionBadgeController::class, 'create'])->name('vignette.create');
Route::get('/vignette/store', [ProductionBadgeController::class, 'store'])->name('vignette.store');
