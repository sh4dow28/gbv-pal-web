...
Route::post('/production/retrait/badge/{$idProd}', [ProductionBadgeController::class, 'edit'])->name('badge.retrait');
...
Route::post('/production/retrait/vignette/{$idProd}', [ProductionVignetteController::class, 'withdrawal'])->name('vignette.retrait');
