...
Route::get('/productions/badges', [ProductionBadgeController::class, 'index'])->name('badge.create');
...
Route::get('/productions/vignettes', [ProductionVignetteController::class, 'index'])->name('vignette.create');
