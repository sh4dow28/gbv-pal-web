...
Route::get('/productions/badges', [ProductionBadgeController::class, 'create'])->name('badge.create');
...
Route::get('/productions/vignettes', [ProductionVignetteController::class, 'create'])->name('vignette.create');
