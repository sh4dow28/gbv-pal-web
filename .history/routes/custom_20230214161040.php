...
Route::get('/societies', [SocieteController::class, 'index'])->name('societies')->middleware('isLoggedIn');
...
Route::get('/visitors', [VisiteurController::class, 'index'])->name('visiteurs');


Route::get('/badge/create', [ProductionBadgeController::class, 'create'])->name('badge.create');
Route::get('/productions/badge/requests', [ProductionBadgeController::class, 'index'])->name('productions.badges');
Route::get('/registre/badges', [ProductionBadgeController::class, 'registre'])->name('registre.badges');
Route::post('/production-badge/store', [DemandeProductionController::class, 'store'])->name('badge.store');
Route::post('/production/retrait/badge', [ProductionBadgeController::class, 'withdrawal'])->name('badge.retrait');

Route::get('/vignette/create', [ProductionVignetteController::class, 'create'])->name('vignette.create');
Route::get('/productions/vignettes/request', [ProductionVignetteController::class, 'index'])->name('productions.vignettes');
Route::get('/registre/vignettes', [ProductionVignetteController::class, 'registre'])->name('registre.vignettes');
Route::post('/production-vignette/store', [DemandeProductionController::class, 'store'])->name('vignette.store');
Route::post('/production/retrait/vignette', [ProductionVignetteController::class, 'withdrawal'])->name('vignette.retrait');
