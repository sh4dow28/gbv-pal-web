...
Route::get('/registre/badges', [ProductionBadgeController::class, 'index'])->name('registre.badges');
...
Route::get('/registre/vignettes', [ProductionVignetteController::class, 'index'])->name('registre.vignettes');
