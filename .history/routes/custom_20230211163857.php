...
Route::post('/badge/store', [ProductionBadgeController::class, 'store'])->name('badge.store');

Route::get('/vignette/create', [ProductionVignetteController::class, 'create'])->name('vignette.create');
Route::post('/vignette/store', [ProductionVignetteController::class, 'store'])->name('vignette.store');
