                            ...
                            <table id="vbadge-list-table" class="table">
                                ...
                                <tbody>
                                    @foreach ($data as $row)
                                        <tr>
                                            <td scope="row">
                                                {{ $carbon::parse($row->dateDemBVisit)->format('d/m/Y à hh:mm:ss') }}
                                            </td>
                                            <td scope="row">
                                                {{ $carbon::parse($row->dateDemBVisit)->format('d/m/Y à hh:mm:ss') }}{{ $row->status }}
                                            </td>
                                            <td scope="row">{{ $row->dateRetBVisit }}</td>
