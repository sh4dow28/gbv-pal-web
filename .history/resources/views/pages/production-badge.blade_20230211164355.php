                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3" method="POST" action=" {{ route('badge.store') }} ">
                                @csrf
                                <input type="text" name="typeProd" value="badge">
                                <div class="row px-3">
                                    <label for="description" class="form-label">Zone à accéder</label>
                                    <div class="row flex">
                                        <label><input type="checkbox" name="zoneAcc[]" value="Mole 1"> Mole 1</label>
                                        <label><input type="checkbox" name="zoneAcc[]" value="Quai pétrolier"> Quai
                                            pétrolier</label>
                                        <label><input type="checkbox" name="zoneAcc[]" value="TOGO TERMINAL"> TOGO
                                            TERMINAL</label>
                                        <label><input type="checkbox" name="zoneAcc[]" value="Quai minéralier"> Quai
                                            minéralier</label>
                                        <label><input type="checkbox" name="zoneAcc[]" value="LCT"> LCT</label>
                                        <label><input type="checkbox" name="zoneAcc[]" value="SNPT"> SNPT</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
