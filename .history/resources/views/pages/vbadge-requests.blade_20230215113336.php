...
@extends('layout.app')
@section('pagetitle')
    GBV-PAL | Les demandes de badge visiteur
@endsection
@section('content')
    <main id="main" class="main">

        <div class="pagetitle">
            <h1>LISTE DES DEMANDES DE BADGE VISITEUR</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href=" {{ route('home') }} ">Acceuil</a></li>
                    <li class="breadcrumb-item">Badge Visiteur</li>
                    <li class="breadcrumb-item active">Les demandes de Badge visiteur</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title text-center">Liste de toute les demandes de badges visiteur</h5>
                            <hr />
                            <!-- Default Table -->
