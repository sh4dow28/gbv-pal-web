                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr />
                            <h5 class="card-title text-center underline">Liste des demandes de production de vignette</h5>
                            <form method="POST" action=" {{ route('vbadge.request.store') }} ">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" name="idProd" class="form-control" id="idProd">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="noVignette" class="form-control text-uppercase"
                                            id="noVignette">
                                    </div>
                                </div>
