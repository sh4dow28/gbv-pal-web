                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3" method="POST" action=" {{ route('badge.store') }} ">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" value="{{ old('nomEmp') }}" name="nomEmp" class="form-control"
                                        id="nomEmp">
                                </div>
                                <div class="col-md-4">
                                    <label for="prenomEmp" class="form-label">Prénom de l'employé</label>
                                    <input type="text" value="{{ old('prenomEmp') }}" name="prenomEmp"
                                        class="form-control" id="prenomEmp">
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" value="{{ old('pereEmp') }}" name="pereEmp"
                                        class="form-control" id="pereEmp">
                                </div>
                                <div class="col-md-6">
                                    <label for="mereEmp" class="form-label">Nom de la mère</label>
                                    <input type="text" value="{{ old('mereEmp') }}" name="mereEmp"
                                        class="form-control" id="mereEmp">
                                </div>
                                <div class="col-md-4">
                                    <label for="posteEmp" class="form-label">Poste de l'employé</label>
                                    <input type="text" value="{{ old('posteEmp') }}" name="posteEmp"
                                        class="form-control" id="posteEmp">
                                </div>
                                <div class="col-md-4">
                                    <label for="dobEmp" class="form-label">Date de naissance de l'employé</label>
                                    <input type="date" value="{{ old('dobEmp') }}" name="dobEmp"
                                        class="form-control" id="dobEmp">
                                </div>
                                <div class="col-md-4">
                                    <label for="pobEmp" class="form-label">Lieu de naissance de l'employé</label>
                                    <input type="text" value="{{ old('pobEmp') }}" name="pobEmp"
                                        class="form-control" id="pobEmp">
                                </div>
                                <div class="col-md-4">
                                    <label for="nationEmp" class="form-label">Nationnalité de l'employé</label>
                                    <input type="text" value="{{ old('nationEmp') }}" name="nationEmp"
                                        class="form-control" id="nationEmp">
                                </div>
                                <div class="col-md-4">
                                    <label for="adrEmp" class="form-label">Adresse de l'employé</label>
                                    <input type="text" value="{{ old('adrEmp') }}" name="adrEmp"
                                        class="form-control" id="adrEmp">
                                </div>
                                <div class="col-md-4">
                                    <label for="telEmp" class="form-label">Téléphone de l'employé</label>
                                    <input type="text" value="{{ old('telEmp') }}" name="telEmp"
                                        class="form-control" id="telEmp">
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" value="{{ old('numIDEmp') }}" name="numIDEmp"
                                        class="form-control" id="numIDEmp">
                                </div>
                                <div class="col-md-4">
                                    <label for="expIDEmp" class="form-label">Date d'expiration de la pièce</label>
                                    <input type="date" value="{{ old('expIDEmp') }}" name="expIDEmp"
                                        class="form-control" id="expIDEmp">
                                </div>
                                <div class="col-md-12">
                                    <label for="numFisc" class="form-label">Numéro d'identification de la société où
                                        travail le concerné</label>
                                    <input type="text" value="{{ old('numFisc') }}" name="numFisc"
                                        class="form-control" id="numFisc">
                                </div>
