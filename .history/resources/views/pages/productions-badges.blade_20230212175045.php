                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <hr />
                            <h5 class="text-center text-decoration-underline">Enregistrer un retrait de badge</h5>
                            <p class="text-center">
                                <i>Veuillez renseigner le numero de la production et le numero du badge</i>
                            </p>
                            <form method="POST" action=" {{ route('badge.retrait') }} ">
                                @csrf
                                <div class="row mb-3">
