                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <form class="row g-3 needs-validation" novalidate>
                                ...
                                <div class="col-12">
                                    <label for="yourPost" class="form-label">Poste occupé</label>
                                    <input type="text" name="name" class="form-control" id="yourPost" required>
                                    <div class="invalid-feedback">Veuillez entrer le poste de l'utilisateur s'il vous plaît
                                        !
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <label for="yourConfPassword" class="form-label">Retapez le mot de passe</label>
                                    <input type="password" name="password" class="form-control" id="yourConfPassword"
                                        required>
                                    <div class="invalid-feedback">Entrez un mot de passe s'il vous plaît !</div>
                                </div>

                                <div class="col-12 text-center">
                                    <a class="btn btn-primary w-50" type="submit" href="#">
                                        Créer l'utilisateur
                                    </a>
                                </div>
                            </form>
