                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <form class="row g-3 needs-validation" method="POST" action="{{ url('register') }}" novalidate>
                                ...
                                @if (Session::get('fail'))
                                    <div class="py-1">
                                        <p class="text-success text-center small"> {{ Session::get('fail') }} </p>
                                    </div>
                                @elseif (Session::get('message'))
                                    <div class="py-1">
                                        <p class="text-success text-center small"> {{ Session::get('message') }} </p>
                                    </div>
                                @endif
                                <div class="col-12">
                                    <label for="yourFullname" class="form-label">Nom complet</label>
                                    <input type="text" value="{{ old('nomUtil') }}" name="nomUtil" class="form-control"
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="droitUtil" id="yourPost" class="form-control">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" value="{{ old('pseudoUtil') }}" name="pseudoUtil"
                                ...
                                <div class="col-12 text-center">
                                    <input class="btn btn-primary w-50" type="submit" value="Créer l'utilisateur" />
                                </div>
                            </form>
