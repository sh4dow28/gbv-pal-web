...
<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        @if (Session::has('loginID')->droitUtil == 'admin' || Session::has('loginID')->droitUtil == 'session-visiteur')
        ...
        @if (Session::has('loginID')->droitUtil == 'admin' || Session::has('loginID')->droitUtil == 'session-access')
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href=" {{ route('vignette.create') }} ">
                    <span>Enregistrer un retrait</span>
                </a>
            </li>
            <li class="nav-item">
        ...
        @if (Session::has('loginID')->droitUtil == 'admin')
