            ...
            <li class="nav-item dropdown pe-3">
                @if (Session::has('loginID'))
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="{{ route('home') }}"
                        ...
                        <span class="d-none d-md-block dropdown-toggle ps-2"> {{ Session::get('loginID')->pseudoUtil }}
                        </span>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card">
                    <div class="card-body">
                        <!-- V.Badge return Form -->
                        <form method="POST" action=" {{ route('vbadge.request.return') }} ">
                            @csrf
                            <div class="row mb-3 mt-4">
                                <label for="inputBadge" class="col-sm-5 col-form-label">Numéro du badge</label>
                                <div class="col-sm-7">
                                    <input type="text" name="no_badge" class="form-control" id="inputBadge">
                                </div>
                            </div>
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary">Terminer</button>
