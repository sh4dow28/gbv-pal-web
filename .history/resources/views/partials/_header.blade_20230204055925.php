        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card">
                    <div class="card-body">
                        <!-- V.Badge add Form -->
                        <form action=" {{ route('vbadge.add') }} " method="POST">
                            @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card">
                    <div class="card-body">
                        <!-- V.Badge return Form -->
                        <form method="POST" action=" {{ route('vb.request') }} ">
                            <div class="row mb-3 mt-4">
                                <label for="inputBadge" class="col-sm-5 col-form-label">Numéro du badge</label>
                                <div class="col-sm-7">
...
</div><!-- End V.Badge request return Modal-->
                    ...
                    <div class="card-body">
                        ...
                        <form>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-7">
                                    <select name="id-type" id="idType" class="form-select">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-7">
                                    <input type="date" class="form-control" id="inputBadge">
                                </div>
                            </div>
                            <div class="row mb-2">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control text-uppercase" id="inputBadge">
                                </div>
                            </div>
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary">Terminer</button>
