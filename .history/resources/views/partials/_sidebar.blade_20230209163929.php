    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-journal-text"></i><span>Badge visiteur</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href=" {{ route('vbadge.list') }} ">
                        <i class="bi bi-circle"></i><span>Liste</span>
                    </a>
                </li>
                <li>
                    <a data-bs-toggle="modal" data-bs-target="#newvisitorbadgemodal">
                        <i class="bi bi-circle"></i><span>Nouveau Badge</span>
                    </a>
                </li>
                <li>
                    <a href=" {{ route('visitor-badge-request') }} ">
                        <i class="bi bi-circle"></i><span>Liste des Demandes de badge</span>
                    </a>
                </li>
                <li>
                    <a data-bs-toggle="modal" data-bs-target="#requestbadgemodal">
                        <i class="bi bi-circle"></i><span>Nouvelle demande</span>
                    </a>
                </li>
                <li>
                    <a data-bs-toggle="modal" data-bs-target="#returnbadgemodal">
                        <i class="bi bi-circle"></i><span>Retour de badge</span>
                    </a>
                </li>

            </ul>
        </li><!-- End visitor badge options -->
